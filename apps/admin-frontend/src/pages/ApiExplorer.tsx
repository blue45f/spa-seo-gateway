...
const COMMON: Endpoint[] = [
  {
    ...
    path: '/health',
    auth: 'public',
    desc: 'Liveness — 풀/캐시/breaker 상태 JSON',
  ...
  },
  {
    ...
    path: '/health/deep',
    auth: 'public',
    desc: 'Deep readiness — 실제 1회 렌더 후 OK. 시간 걸림 (수초)',
  ...
  },
  {
    ...
    path: '/metrics',
    auth: 'public',
    desc: 'Prometheus exposition — 시각화는 Metrics 탭',
  ...
  },
  {
    ...
    auth: 'public',
    desc: '비민감 게이트웨이 정보 (모드, origin, uptime). Welcome 페이지에서 사용',
  ...
  },
  {
    ...
    path: '/admin/api/routes',
    auth: 'admin',
    desc: '라우트 일괄 교체. persist:true 면 디스크 영구화',
  ...
  },
  {
    ...
    auth: 'admin',
    desc: '최근 200건 감사 이벤트 (HMAC chain)',
  ...
  },
  {
    ...
    auth: 'admin',
    desc: '감사 체인 무결성 검증 — 변조 시 brokenAt 인덱스 반환',
  ...
  },
  {
    ...
    auth: 'admin',
    desc: 'URL 스크린샷 → baseline 비교 (pixelmatch)',
  ...
  },
  {
    ...
    auth: 'admin',
    desc: 'AI 어댑터로 schema.org JSON-LD 추론',
  ...
  },
  {
    ...
    auth: 'admin',
    desc: 'Lighthouse 점수 측정 (peer dep 필요)',
...
const SAAS_EXTRA: Endpoint[] = [
  ...
  },
  {
    ...
    auth: 'apiKey',
    desc: '[SaaS] 테넌트가 자기 캐시 무효화 (apiKey 인증)',
